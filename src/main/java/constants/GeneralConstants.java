...
public class GeneralConstants {
    //Property files
    public static String DATA_PROPERTIES_FILE_NAME = "./data.properties";
    public static String CREDENTIALS_DATA_PROPERTIES_FILE_NAME = "./credentialsData.properties";
  ...
  //Info Section Pharmacypage
    ...
    public static String DATE_TIME_FORMAT_PATTERN="ddMMyyyy_HHmmss";

    //Folders
    public static String FOLDERS_TARGET_DOWNLOADS="\\target\\downloads\\";

    //Attributes
    public static String DATA_VALUE_ATTRIBUTE = "data-value";
