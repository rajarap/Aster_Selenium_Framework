	...
	public static void send(String from, String tos[], String subject, String text) throws MessagingException {
		...
		Session session = Session.getDefaultInstance(props, new javax.mail.Authenticator() {
			protected PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication("test01@gmail.com", "pass1234");// change accordingly
			}
		});
		...
		try {
			...
			String filename = "C:/AsterWebAutomation/test-output/index.html";

			BodyPart objMessageBodyPart = new MimeBodyPart();
			// Option 3: Send text along with attachment
			objMessageBodyPart.setContent("<h1>Automation Execution Results</h1></br>" + text, "text/html");
